...
export default function Testimony() {
    return (
        <section className="testimony">
            ...
            <div className="testimony__content dark:bg-jet pb-10">
                <div className="testimony__list max-w-[1200px] mx-auto -mt-24 z-20 px-5 grid grid-cols-1 md:grid-cols-2 gap-10">
                    <div className="testimony__card p-10 bg-white dark:bg-davys-gray dark:text-white rounded-3xl shadow-2xl overflow-hidden hover:-translate-y-2 transition ease-linear duration-300">
