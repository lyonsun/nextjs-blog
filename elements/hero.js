                ...
                <div className="hero__text max-w-md mx-auto md:mx-0 text-center md:text-left">
                    ...
                    <div className="hero__buttons inline-flex gap-4 flex-col lg:flex-row transition-all ease-linear duration-300">
                        <Link href="mailto:sunly917@gmail.com">
                            <a className="uppercase px-10 py-6 text-white bg-indigo-600 rounded-full text-sm font-medium hover:outline hover:outline-1 hover:outline-indigo-600 hover:text-indigo-600 hover:bg-white transition-colors ease-linear duration-300"><i className="fa-regular fa-envelope mr-2"></i> CONTACT ME</a>
                        </Link>
                        <Link href="/cv/curriculum-vitae-x.pdf">
                            <a className="uppercase px-10 py-6 text-[#333333] text-sm font-medium rounded-full hover:bg-indigo-600 hover:text-white transition-colors ease-linear duration-300" download target='__blank'><i className="fa-solid fa-download mr-2"></i> DOWNLOAD CV</a>
                        </Link>
                    </div>
                </div>
