...
export default function Hero() {
    return (
        <section className="hero bg-neutral dark:bg-gray">
            <div className="relative px-5 py-8 max-w-[1200px] mx-auto grid grid-cols-1 md:grid-cols-2 gap-10 items-center transition-all ease-linear duration-300">
                <div className="hero__text px-2 text-center md:text-left">
                    ...
                    <div className="py-8 font-bold text-4xl leading-[60px] lg:text-6xl lg:leading-[78px] text-dark-gray dark:text-white transition-all ease-linear duration-300">
                    ...
                    <div className="hero__buttons inline-flex gap-4 flex-col lg:flex-row transition-all ease-linear duration-300">
                        ...
                        <Link href="/cv/curriculum-vitae-x.pdf">
                            <a className="uppercase px-10 py-6 text-dark-gray dark:text-white text-sm font-medium rounded-full hover:bg-primary-100 dark:hover:bg-primary-300 dark:hover:text-dark-gray transition-colors ease-linear duration-300" download target='__blank'><i className="fa-solid fa-download mr-2"></i> DOWNLOAD CV</a>
                        </Link>
                    </div>
                </div>
