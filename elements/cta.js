...
export default function CTA() {
    return (
        <section className="cta dark:bg-gray px-5 py-24">
            <div className="cta__inner max-w-[1200px] mx-auto rounded-3xl bg-neutral dark:bg-dark-gray bg-[url('/images/cta-background.svg')] bg-no-repeat bg-center bg-cover">
