...
export default function Service() {
    return (
        <section className="service dark:bg-jet">
            <div className="px-5 pt-12 pb-12 md:pb-36 max-w-[1200px] mx-auto">
                ...
                <div className="cards grid grid-cols-1 md:grid-cols-3 gap-10 place-items-center">
                    <div className="card hover:bg-neutral dark:bg-davys-gray dark:hover:bg-davys-gray dark:hover:bg-opacity-60 text-center px-8 py-12 rounded-3xl shadow-2xl transition-colors ease-in duration-100">
