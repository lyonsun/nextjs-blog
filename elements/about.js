...
export default function About() {
    return (
        <section className={`about ${styles["bg-about"]} bg-neutral dark:bg-gray relative`}>
            <div className={styles["about__inner"]}>
                <div className="px-5 py-24 max-w-[1200px] mx-auto">
                    <div className="about__content max-w-[600px] mx-auto md:mx-0 text-center md:text-left transition-all ease-in-out duration-300">
                        ...
                        <div className="py-8 font-bold text-4xl leading-[60px] lg:text-6xl lg:leading-[78px] text-dark-gray dark:text-white transition-all ease-linear duration-300">Web Developer With 10 Years Of Experience.</div>
                        <div className="text-gray dark:text-white opacity-70">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Cras vitae blandit lectus. Praesent at hendrerit velit, at dictum nisl.</div>
                        <div className="mt-8">
